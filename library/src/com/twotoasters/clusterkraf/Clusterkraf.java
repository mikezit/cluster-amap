...
/**
 * Clusters InputPoint objects on a AMap
 */
public class Clusterkraf {
	 ...
	 * 
	 * @param map
	 *            The AMap to be managed by Clusterkraf
	 * @param options
	 *            Customized options
	 */
	public Clusterkraf(AMap map, Options options, ArrayList<InputPoint> points) {
		this.mapRef = new WeakReference<AMap>(map);
	...
	private static class InnerCallbackListener implements ClusteringOnCameraChangeListener.Host, ClusterTransitionsAnimation.Host, OnMarkerClickListener,
		...
		/**
		 * @see com.amap.api.maps.AMap.OnMarkerClickListener#onMarkerClick
		...
		/**
		 * @see com.amap.api.maps.AMap.OnInfoWindowClickListener#
		 *      onInfoWindowClick(com.amap.api.maps.model.Marker)
		 */
		@Override
        ...
        /**
         * @see com.amap.api.maps.AMap.InfoWindowAdapter
         *      getInfoWindow(com.amap.api.maps.model.Marker)
         */
        @Override
        ...
        /**
         * @see com.amap.api.maps.AMap.InfoWindowAdapter
         *      getInfoContents(com.amap.api.maps.model.Marker)
         */
        @Override
